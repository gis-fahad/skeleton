...
export function main() {
    ...
    fetch("jscroot/template/content/Geo/chapter2/map.json")
  ...
  const polygonGeoJSONUrl = 'jscroot/template/content/Geo/chapter2/map.json';
  const lineStringGeoJSONUrl = 'jscroot/template/content/Geo/chapter2/map.json';
  const pointGeoJSONUrl = 'jscroot/template/content/Geo/chapter2/map.json';
